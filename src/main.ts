import { SsDomCreate } from "./SsDomCreate";
import { SsFileReader } from "./SsFileReader";
import { SsPlayButton } from "./SsPlayButton";
...
class Main {
    ...
    public main() {
        ...
        // ファイル読み込み機能の呼び出し
        new SsFileReader($('#file')[0], $photoArea[0]);
        // 再生ボタン機能の呼び出し
        new SsPlayButton($('#play')[0]);
    }
