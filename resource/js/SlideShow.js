...
var SlideShowDomCreate = (function () {
    ...
    SlideShowDomCreate.prototype.createDom = function () {
        var element = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slideshow-wrap")[0];
        if (!element) {
            var slideshowWrap = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            slideshowWrap.attr({ id: "slideshow-wrap", class: "background-image" });
            var fileArea = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            fileArea.attr({ id: "file-area" });
            var fileAreaItem1 = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            fileAreaItem1.attr({ class: "file-area-item" });
            var fileDialog = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<input webkitdirectory multiple />");
            fileDialog.attr({
                id: "file",
                type: "file",
            ...
            var fileAreaItem2 = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            fileAreaItem2.attr({ class: "file-area-item" });
            var playButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<button></button>");
            playButton.attr({ id: "play", title: "再生ボタン" });
            var buttonIcon = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>");
            buttonIcon.attr({ class: "ui-icon ui-icon-play" });
            playButton.append(buttonIcon);
            fileAreaItem2.append(playButton);
            var progress = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<progress></progress>");
            progress.attr({ id: "meter", max: "100", value: "0" });
            fileAreaItem2.append(progress);
            fileArea.append(fileAreaItem2);
            var fileAreaItem3 = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            fileAreaItem3.attr({ class: "file-area-item" });
            var meterText = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<label></label>");
            meterText.attr({ id: "meter-text", for: "meter" });
            fileAreaItem3.append(meterText);
            fileArea.append(fileAreaItem3);
            var hr = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<hr>");
            hr.attr({ class: "line" });
            fileArea.append(hr);
            slideshowWrap.append(fileArea);
            var settingArea = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            settingArea.attr({ class: "setting-area" });
            var settingButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<button></button>");
            settingButton.attr({ id: "setting", title: "設定ボタン" });
            var settingButtonIcon = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<span></span>");
            ...
            var displayArea = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            displayArea.attr({ id: "display-area" });
            var explanationText = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            ...
            var leftButtonDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            leftButtonDiv.attr({ id: "left-side", class: "hidden-area" });
            var leftButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            ...
            var rightButtonDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            rightButtonDiv.attr({ id: "right-side", class: "hidden-area" });
            var rightButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            ...
            var photoArea = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div></div>");
            photoArea.attr({ id: "photo-area" });
            displayArea.append(photoArea);
            slideshowWrap.append(displayArea);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').append(slideshowWrap);
        }
    };
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _MimeType__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MimeType */ "./src/MimeType.ts");
/* harmony import */ var _PhotoData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PhotoData */ "./src/PhotoData.ts");
/* harmony import */ var _SlideShowManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SlideShowManager */ "./src/SlideShowManager.ts");
...
var SlideShowFileReader = (function () {
    ...
    SlideShowFileReader.prototype._addEventListener = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.fileElement).on('change', function (ev) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.readFiles(ev)];
                    case 1:
                        _a.sent();
                        this.slideShowManager = new _SlideShowManager__WEBPACK_IMPORTED_MODULE_3__["SlideShowManager"](this.photoAreaElement, this.photoArray);
                        return [2];
                }
            });
        }); });
    ...
    SlideShowFileReader.prototype.readFiles = function (ev) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.photoArray = new Array();
                meter = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#meter");
                meterText = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#meter-text");
                fileMax = ev.target.files.length;
                fileCount = 0;
                _loop_1 = function (i) {
                    var file = ev.target.files[i];
                    if (!_MimeType__WEBPACK_IMPORTED_MODULE_1__["MimeType"].isAvailable(file.type)) {
                    ...
                    fileReader.onload = function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            photo = new _PhotoData__WEBPACK_IMPORTED_MODULE_2__["PhotoData"](file, url);
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _PhotoMode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PhotoMode */ "./src/PhotoMode.ts");
/* harmony import */ var _SlideShowToggleMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SlideShowToggleMenu */ "./src/SlideShowToggleMenu.ts");
/* harmony import */ var _SlideShowPhotoChange__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SlideShowPhotoChange */ "./src/SlideShowPhotoChange.ts");
...
var SlideShowManager = (function () {
    function SlideShowManager(element, array) {
        ...
        this.resetFlg = false;
        this.endFlg = false;
        this.mode = _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].NORMAL;
        this.time = 5;
        this.toggleMenu = new _SlideShowToggleMenu__WEBPACK_IMPORTED_MODULE_2__["SlideShowToggleMenu"](this);
        this.change = new _SlideShowPhotoChange__WEBPACK_IMPORTED_MODULE_3__["SlideShowPhotoChange"](element, array);
        this._addEventListener();
    }
    SlideShowManager.prototype._addEventListener = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#play').on('click', function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.explanation').hide();
    ...
    SlideShowManager.prototype.addChangeEventListener = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#left-button').on('click', function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#right-button').on('click', function () {
            if (!_this.change.isLock) {
                _this.resetFlg = true;
                _this.changePhoto(_this.time);
            }
    ...
    SlideShowManager.prototype.addKeybordEventListener = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slideshow-wrap").on('keydown', function (e) {
            if (e.key === 'ArrowLeft') {
                if (!_this.change.isLock) {
                    _this.change.subCount();
                    _this.change.subCount();
                ...
                if (_this.change.isLock) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#file-area').append(lockDiv);
                }
                else {
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#lock').remove();
                    _this.resetFlg = true;
                    _this.changePhoto(_this.time);
                }
            }
    ...
    SlideShowManager.prototype.addMousewheelEventListener = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slideshow-wrap").on('mousewheel', function (ev) {
            if (ev.wheelDelta > 0) {
                if (!_this.change.isLock) {
                    _this.change.subCount();
                    _this.change.subCount();
    ...
    SlideShowManager.prototype.destructor = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#play').off('click');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#left-button').off('click');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('right-button').off('click');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slideshow-wrap").off('keydown');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slideshow-wrap").off('mousewheel');
        this.endFlg = true;
...
var SlideShowPhotoChange = (function () {
    ...
    SlideShowPhotoChange.prototype.changePhoto = function (mode, time) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).empty();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slideshow-wrap").css({
            'background-image': "url(" + photo.filePath + ")",
        });
        switch (mode) {
            case _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].NORMAL:
                this.changeByHeight(photo);
                break;
            case _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].ZOOMOUT:
                this.changeByZoomOut(photo);
                break;
            case _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].SLIDEIN:
    ...
    SlideShowPhotoChange.prototype.changeByHeight = function (photo) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).css({ "text-align": "center" });
        var areaHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).height();
        var areaWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).width();
        var url = photo.filePath;
        var element = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<img>').addClass('photo').attr('src', url);
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).append(element);
    ...
    SlideShowPhotoChange.prototype.changeByZoomOut = function (photo) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).css({ "position": "relative" });
        var areaHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).height();
        var areaWidth = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.photoAreaElemet).width();
        var url = photo.filePath;
...
var SlideShowPlayButton = (function () {
    function SlideShowPlayButton(element) {
        this.button = element;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.button).prop('disabled', true);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#left-side').css({ "display": "none" });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#right-side').css({ "display": "none" });
        this._addEventListener();
    }
    SlideShowPlayButton.prototype._addEventListener = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#file').on('change', function (ev) {
            if (ev.target.files.length > 0) {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(_this.button).prop('disabled', false);
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#left-side').css({ "display": "none" });
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('#right-side').css({ "display": "none" });
            }
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#play').on('click', function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(_this.button).prop('disabled', true);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#left-side').css({ "display": "block" });
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#right-side').css({ "display": "block" });
        });
    };
...
var SlideShowToggleMenu = (function () {
    ...
    SlideShowToggleMenu.prototype.menuInit = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#toggle-menu').remove();
        var menuDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        menuDiv.attr({
            id: "toggle-menu",
            class: "menu"
        });
        var titleDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        titleDiv.attr("id", "menu-title");
        titleDiv.text("Settings");
        menuDiv.append(titleDiv);
        var hr = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<hr>');
        menuDiv.append(hr);
        var modeDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        modeDiv.attr("id", "mode");
        var modeTitleDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        modeTitleDiv.attr({ id: "menu-subtitle", class: "menu-subtitle" });
        modeTitleDiv.text("Mode:");
        modeDiv.append(modeTitleDiv);
        var normalDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        normalDiv.attr({ id: "normal-mode", class: "menu-item" });
        var normalRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        normalRadio.attr({
            id: "normal",
            type: "radio",
            name: "mode",
        ...
        var normalLabel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        normalLabel.attr("for", "normal");
        normalLabel.text("Normal");
        normalDiv.append(normalLabel);
        modeDiv.append(normalDiv);
        var zoomoutDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        zoomoutDiv.attr({ id: "zoomout-mode", class: "menu-item" });
        var zoomoutRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        zoomoutRadio.attr({
            id: "zoomout",
            type: "radio",
            name: "mode",
        ...
        var zoomoutLabel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        zoomoutLabel.attr("for", "zoomout");
        zoomoutLabel.text("ZoomOut");
        zoomoutDiv.append(zoomoutLabel);
        modeDiv.append(zoomoutDiv);
        var slideinDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        slideinDiv.attr({ id: "slidein-mode", class: "menu-item" });
        var slideinRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        slideinRadio.attr({
            id: "slidein",
            type: "radio",
            name: "mode",
        ...
        var slideinLabel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        ...
        var timeDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        timeDiv.attr("id", "time");
        var timeTitleDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        timeTitleDiv.attr({ id: "time-subtitle", class: "menu-subtitle" });
        timeTitleDiv.text("Time:");
        timeDiv.append(timeTitleDiv);
        var sec3Div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        sec3Div.attr({ id: "sec3-time", class: "menu-item" });
        var sec3Radio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        sec3Radio.attr({
            id: "sec3",
            type: "radio",
            name: "time",
        ...
        var sec3Label = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        sec3Label.attr("for", "sec3");
        sec3Label.text("3s");
        sec3Div.append(sec3Label);
        timeDiv.append(sec3Div);
        var sec5Div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        sec5Div.attr({ id: "sec5-time", class: "menu-item" });
        var sec5Radio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        sec5Radio.attr({
            id: "sec5",
            type: "radio",
            name: "time",
        ...
        var sec5Label = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        sec5Label.attr("for", "sec5");
        sec5Label.text("5s");
        sec5Div.append(sec5Label);
        timeDiv.append(sec5Div);
        var sec10Div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        sec10Div.attr({ id: "sec10-time", class: "menu-item" });
        var sec10Radio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        sec10Radio.attr({
            id: "sec10",
            type: "radio",
            name: "time",
        ...
        var sec10Label = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        sec10Label.attr("for", "sec10");
        sec10Label.text("10s");
        sec10Div.append(sec10Label);
        timeDiv.append(sec10Div);
        menuDiv.append(timeDiv);
        var orderDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        orderDiv.attr("id", "order");
        var orderTitleDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        orderTitleDiv.attr({ id: "order-subtitle", class: "menu-subtitle" });
        orderTitleDiv.text("Order:");
        orderDiv.append(orderTitleDiv);
        var defaultOrderDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        defaultOrderDiv.attr({ id: "default-order", class: "menu-item" });
        var defaultOrderRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        ...
        var defaultOrderLabel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        ...
        var randomOrderDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>');
        randomOrderDiv.attr({ id: "random-order", class: "menu-item" });
        var randomOrderRadio = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input/>');
        ...
        var randomOrderLabel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<label></label>');
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.setting-area').append(menuDiv);
    };
    SlideShowToggleMenu.prototype.addTogglemenuEventListener = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#setting').on('click', function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#toggle-menu').slideToggle();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#toggle-menu').toggleClass('active');
        });
        this.modeAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#normal"), _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].NORMAL);
        this.modeAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#zoomout"), _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].ZOOMOUT);
        this.modeAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slidein"), _PhotoMode__WEBPACK_IMPORTED_MODULE_1__["PhotoMode"].SLIDEIN);
        this.timeAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sec3"), 3);
        this.timeAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sec5"), 5);
        this.timeAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sec10"), 10);
        this.orderAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#default"), true);
        this.orderAddEvent(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#random"), false);
    };
    SlideShowToggleMenu.prototype.destructor = function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#setting').off('click');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#zoomout").off('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#slidein").off('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sec3").off('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sec5").off('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sec10").off('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#default").off('change');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#random").off('change');
    };
